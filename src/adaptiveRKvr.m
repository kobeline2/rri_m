function [vr_err, vr_temp] = adaptiveRKvr(ddt, qr_ave_temp_idx, ParamRK, vr_idx, qr_idx, hr_idx, funcr_vr4RK)
    
    % %% Adaptive Runge-Kutta
    % % (1)
    [fr, vr_idx, qr_idx] = funcr_vr4RK(vr_idx, qr_idx, hr_idx);   
